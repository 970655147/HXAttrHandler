...
//	public static final String QUOTE = "'";
	...
	public static final OperationAttrHandler defaultOperationAttrHandler = new MapOperationAttrHandler(new DoNothingAttrHandler(), StandardHandlerParser.Types.String);
